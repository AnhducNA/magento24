...
class Rule extends AbstractModel implements IdentityInterface
{
     ...
     *
     */
    const CACHE_TAG = 'tigren_customergroupcatalog_rule';
    /**
     * @var string
     */
    protected $_cacheTag = 'tigren_customergroupcatalog_rule';

    /**
     * @var string
     */
    protected $_eventPrefix = 'tigren_customergroupcatalog_rule';
