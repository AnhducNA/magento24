...
class Rule extends AbstractModel implements IdentityInterface
{
     ...
     *
     */
    const CACHE_TAG = 'tigren_customer_group_catalog_rule';
    /**
     * @var string
     */
    protected $_cacheTag = 'tigren_customer_group_catalog_rule';

    /**
     * @var string
     */
    protected $_eventPrefix = 'tigren_customer_group_catalog_rule';
