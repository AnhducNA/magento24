 ...
 * @since 1.3.0
 */
class CustomerConditions extends \Magento\Backend\Block\Widget\Form\Generic
    implements
    \Magento\Ui\Component\Layout\Tabs\TabInterface
{
    ...
    {
        $model
            = $this->_coreRegistry->registry(RegistryConstants::CURRENT_GROUPCAT_RULE_ID);
    ...
    protected function addTabToForm(
        ...
        $newChildUrl = $this->getUrl(
            'tigren_customergroupcatalog/rule/newActionHtml/form/'
            .$actionsFieldSetId,
        ...
        $renderer = $this->_rendererFieldset->setTemplate(
            'Tigren_CustomerGroupCatalog::rule/condition/fieldset.phtml'
        )->setNewChildUrl(
            $newChildUrl
        )->setFieldSetId(
            $actionsFieldSetId
