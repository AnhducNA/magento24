...
use Tigren\Customer\Api\QuestionRepositoryInterface;
 ...
 * @inheritdoc
 */
class CategoryLinkRepository implements QuestionRepositoryInterface, CategoryListDeleteBySkuInterface
{
    /**
